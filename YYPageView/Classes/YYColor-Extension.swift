...
public extension UIColor {
    ...
    ///
    /// - Returns: UIColor
    public class func yy_randomColor() -> UIColor {
    ...
    public class func yy_getRGBDelta(_ firstColor: UIColor, _ secondColor: UIColor) -> (CGFloat, CGFloat, CGFloat) {
    ...
    public func yy_getRGB() -> (CGFloat, CGFloat, CGFloat) {
